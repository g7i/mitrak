  ...
  return (
    <Cont>
      ...
      <ul>
        ...
        <li><strong>Total Labs: </strong> 10 (Each having Area 900 Square meter)</li>
        <li><strong>Internet Facility: </strong> 10 (Each having Area 900 Square meter)</li>
        <li><strong>Projector: </strong> 10 (Each having Area 900 Square meter)</li>
        <li><strong>Audio System: </strong> 10 (Each having Area 900 Square meter)</li>
        <li><strong>Wi-Fi: </strong> 10 (Each having Area 900 Square meter)</li>
        <li><strong>Power Supply: </strong> 10 (Each having Area 900 Square meter)</li>
