...
function News_1() {
  ...
  return (
    <div class="news_1">
        <div class="box1" style={{width:'100%',height:'5vmax',backgroundColor:"#F4C430"}} >
                <div class='marquee' >
        ...
        <div class="box1" style={{width:'100%',height:'5vmax',backgroundColor:"#fff"}}>
                <div class='marquee' >
                    <div class='marqueeContentContainer' >
                    {newsList
        ...
        <div class="box1" style={{width:'100%',height:'5vmax',backgroundColor:"#1FAA59"}}>
                <div class='marquee' >
                    <div class='marqueeContentContainer' >
